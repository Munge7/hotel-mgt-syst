...
<html>
	...
	<body style="background: #f2f2f2;">
		...
		<h1>THE <p style="color: #e6b800; display: inline;">LUXURY</p> HOTEL</h1>
		...
		<div class="mySlides fade">
		  ...
		  <div class="text">ENJOY YOUR EXPERIENCE</div>
		</div>
		...
		<div id="contact" class="footer">
			...
			<h3 class="foot-text">Developers: Peter Munge and friends </h3>
			<h4 class="foot-text">+254742303316</h4><br>
		</div>
	</body>
</html>